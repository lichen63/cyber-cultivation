...
/// Computes exact dates of the 24 Chinese solar terms using astronomical solar longitude.
/// Ported from calendar-pro (https://github.com/yelog/calendar-pro).
struct SolarTermResolver {
  /// Returns the solar term name if the given date falls on a solar term day, else nil.
  func solarTermName(for date: Date) -> String? {
...
private enum SolarTerm: CaseIterable {
  ...
  var displayName: String {
    ...
    case .beginningOfSpring: return "立春"
    case .rainWater: return "雨水"
    case .awakeningOfInsects: return "惊蛰"
    case .springEquinox: return "春分"
    case .pureBrightness: return "清明"
    case .grainRain: return "谷雨"
    case .beginningOfSummer: return "立夏"
    ...
    case .beginningOfAutumn: return "立秋"
    case .limitOfHeat: return "处暑"
    case .whiteDew: return "白露"
    case .autumnEquinox: return "秋分"
    case .coldDew: return "寒露"
    case .frostDescent: return "霜降"
    case .beginningOfWinter: return "立冬"
    case .minorSnow: return "小雪"
    case .majorSnow: return "大雪"
  ...
  var targetLongitude: Double {
    switch self {
    case .minorCold: return 285
    case .majorCold: return 300
    case .beginningOfSpring: return 315
    case .rainWater: return 330
    case .awakeningOfInsects: return 345
    case .springEquinox: return 0
    case .pureBrightness: return 15
    case .grainRain: return 30
    case .beginningOfSummer: return 45
    case .grainFull: return 60
    case .grainInEar: return 75
    case .summerSolstice: return 90
    case .minorHeat: return 105
    case .majorHeat: return 120
    case .beginningOfAutumn: return 135
    case .limitOfHeat: return 150
    case .whiteDew: return 165
    case .autumnEquinox: return 180
    case .coldDew: return 195
    case .frostDescent: return 210
    case .beginningOfWinter: return 225
    case .minorSnow: return 240
    case .majorSnow: return 255
    case .winterSolstice: return 270
    }
  }

  var approximateMonth: Int {
    switch self {
    case .minorCold, .majorCold: return 1
    case .beginningOfSpring, .rainWater: return 2
    case .awakeningOfInsects, .springEquinox: return 3
    case .pureBrightness, .grainRain: return 4
    case .beginningOfSummer, .grainFull: return 5
    case .grainInEar, .summerSolstice: return 6
    case .minorHeat, .majorHeat: return 7
    case .beginningOfAutumn, .limitOfHeat: return 8
    case .whiteDew, .autumnEquinox: return 9
    case .coldDew, .frostDescent: return 10
    case .beginningOfWinter, .minorSnow: return 11
    case .majorSnow, .winterSolstice: return 12
    }
  }

  var approximateDay: Int {
    switch self {
    case .minorCold: return 5
    case .majorCold: return 20
    case .beginningOfSpring: return 4
    case .rainWater: return 19
    case .awakeningOfInsects: return 5
    case .springEquinox: return 20
    case .pureBrightness: return 4
    case .grainRain: return 20
    case .beginningOfSummer: return 5
    case .grainFull: return 21
    case .grainInEar: return 5
    case .summerSolstice: return 21
    case .minorHeat: return 7
    case .majorHeat: return 23
    case .beginningOfAutumn: return 7
    case .limitOfHeat: return 23
    case .whiteDew: return 7
    case .autumnEquinox: return 23
    case .coldDew: return 8
    case .frostDescent: return 23
    case .beginningOfWinter: return 7
    case .minorSnow: return 22
    case .majorSnow: return 7
    case .winterSolstice: return 21
    }
  }
}
