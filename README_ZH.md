...
### 🗺️ 探索模式
- **随机生成地图** — 150×150 Roguelike 地图，包含山脉、河流、房屋、怪物、Boss 和 NPC
- **行动力系统** — 策略性资源管理——移动、战斗和交互消耗行动力；在房屋中休息恢复
- **战力对决系统** — 使用战斗力（FC）与怪物和 Boss 对战；胜利获得经验值
- **NPC 奇遇** — 遇见 NPC 获得随机效果：经验加成、战力 Buff、地形变化、视野调整、传送等
- **战争迷雾** — 有限视野的可探索地图；支持保存和继续探索进度
