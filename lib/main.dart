...
class _MyAppState extends State<MyApp> with WindowListener, TrayListener {
  ...
  Map<String, String> _buildNativeLabels(String? localeCode) {
    ...
    return {
      ...
      // Calendar
      'calendarTitle': l10n.calendarTitle,
      'calendarToday': l10n.calendarToday,
      'calendarOpenCalendar': l10n.calendarOpenCalendar,
      'calendarWeekMon': l10n.calendarWeekMon,
      'calendarWeekTue': l10n.calendarWeekTue,
      'calendarWeekWed': l10n.calendarWeekWed,
      'calendarWeekThu': l10n.calendarWeekThu,
      'calendarWeekFri': l10n.calendarWeekFri,
      'calendarWeekSat': l10n.calendarWeekSat,
      'calendarWeekSun': l10n.calendarWeekSun,
      'calendarMonths': [
        l10n.calendarMonthJan,
        l10n.calendarMonthFeb,
        l10n.calendarMonthMar,
        l10n.calendarMonthApr,
        l10n.calendarMonthMay,
        l10n.calendarMonthJun,
        l10n.calendarMonthJul,
        l10n.calendarMonthAug,
        l10n.calendarMonthSep,
        l10n.calendarMonthOct,
        l10n.calendarMonthNov,
        l10n.calendarMonthDec,
      ].join(','),
      'calendarYearMonth': l10n.calendarYearMonth('{year}', '{month}'),
      'calendarWeekdays': [
